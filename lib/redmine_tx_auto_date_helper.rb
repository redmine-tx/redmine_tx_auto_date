...
class Issue
  ...
  def update_auto_date!
    ...
    #begin_ratio = Setting.plugin_redmine_tx_auto_date['begin_ratio'].to_i
    #end_ratio = Setting.plugin_redmine_tx_auto_date['end_ratio'].to_i

    old_worker_id = self.worker_id
    old_begin_time = self.begin_time
    old_end_time = self.end_time

    new_worker_id = nil # self.worker_id
    new_begin_time = nil # self.begin_time
    new_end_time = nil # self.end_time
    ...
    self.journals.each do |journal| 
      ...
      # detail_done_ratio = visible_details.find{ |d| d.prop_key == 'done_ratio' }
    ...
    #[ self.worker_id ? User.find( self.worker_id ) : nil, self.begin_time, self.end_time ]
  end
